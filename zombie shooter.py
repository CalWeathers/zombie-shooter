...
img_back = "forest.png" #oyunun arka planı
img_bullet = "bullet.png" #mermi
img_hero = "guy.png" #kahraman
img_enemy = "zombie.png" #düşman
 ...
 #oyunun kendisi: sprite eylemleri, oyunun kurallarını kontrol etme, yeniden çizme
   if not finish:
       ...
       for c in collides:
           ...
           score = score + 1
           monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 80, 50, randint(5, 5))
           monsters.add(monster)
